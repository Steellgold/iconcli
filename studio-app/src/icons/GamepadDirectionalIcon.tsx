...
export interface GamepadDirectionalIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const GamepadDirectionalIcon = ({   size = 24,
  color = 'currentColor',
className,
...props }: GamepadDirectionalIconProps) => {
  return (
    <svg
